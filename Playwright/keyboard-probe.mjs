...
await key('Tab');
check('Tab moves the runtime focus to the next element, mirrored into the overlay', await page.evaluate(() => document.activeElement && document.activeElement.getAttribute('aria-label')) === 'Focus me');
await key('ArrowUp');
