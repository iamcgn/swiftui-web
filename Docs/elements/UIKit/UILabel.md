...
one-line frame), exact in Tier A against Catalyst's UIKit.
...
- A label sized to fit is the text's width rounded up to the pixel by the font's one-line label
  height (`Docs/elements/UIKit/UIFont.md`): "Hello, UIKit" 88 × 20 at 17 pt, "Title" 52 × 41,
  "Headline" 73 × 24.5, "Body" 40.5 × 24.5, "Footnote" 56.5 × 18.5, "Bold 13" 49.5 × 16,
  "Semibold 20" 116 × 24.
- Wrapping at 200: the widest line's width (188.5 for the fox), 40 tall for two 17 pt lines (the
  pitch equals the one-line height for a sized font); a two-line limit gives the same. A one-line
  label reports its whole width whatever the proposal (352.5 for the fox at 120).
...
Open: the ink position of a text-style line (its 24.5 box holds a 24.02 line; unverified until
